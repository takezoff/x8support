...
[左右の辺でのバウンド](#左右の辺でのバウンド)の図と見比べながら見てください。また、ボールのx速度`ball.vx`が負の場合は、`dx`も負になることに注意してください。
...
[上下の辺でのバウンド](#上下の辺でのバウンド)の図と見比べながら見てください。また、ボールのy速度`ball.vy`が負の場合は、`dy`も負になることに注意してください。
...
[角でのバウンド](#角でのバウンド)で説明したとおり、**めり込む長さがより小さい方の軸上でバウンドさせている**のが分かります。
